...
// ─── Real numbers ─────────────────────────────────────────────────────────────
const URGENT_REQUESTS_TOTAL = 889;
const PENALTY_2024 = 662000;
const PENALTY_2023 = 158000;
        ...
        <div className="px-8 py-7 space-y-7 flex-1">
          ...
          <div className="grid grid-cols-4 gap-5">
            <KpiCard
              ...
              context={`$${(PENALTY_2023/1000).toFixed(0)}K grew to $${(PENALTY_2024/1000).toFixed(0)}K. Aug 2024 alone: $101K.`}
              accent="critical"
            />
            <KpiCard
